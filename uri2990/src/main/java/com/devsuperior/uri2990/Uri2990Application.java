...
public class Uri2990Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        List<EmpregadoDeptDTO> result1 = list.stream().map(x -> new EmpregadoDeptDTO(x))
        ...
        System.out.println("RESULTADO SQL JPQL: ");
        ...
        List<EmpregadoDeptDTO> result3 = list.stream().map(x -> new EmpregadoDeptDTO(x))
                .collect(Collectors.toList());
